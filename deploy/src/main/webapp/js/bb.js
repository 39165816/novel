...
$(document).ready(function(){
	...
	wd.focusin(function() {
	if($(this).val()=="可搜书名和作者的中文或拼音") $(this).val("");
	});
	// down
	...
	if($(this).val()=='') $(this).val("可搜书名和作者的中文或拼音");
	}); 
...
document.writeln("<p>Copyright &copy; 2014 书中书 All Rights Reserved.  站长邮箱: szs_admin@163.com </p>");
